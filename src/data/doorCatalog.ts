...
const DEFAULT_HANDLE_FINISHES = ['cromo_satinato', 'cromo_lucido', 'bianco_optical', 'nero', 'grigio_alluminio', 'grafite_satinato', 'oro_satinato', 'oro_antico_lucido', 'ottone_lucido', 'nikel_lucido', 'bronzo_satinato', 'cromo_lucido_satinato', 'cromo_lucido_bianco', 'cromo_lucido_nero', 'bianco'];
