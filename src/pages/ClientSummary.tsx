    ...
    <AppLayout>
      <div className="p-6 max-w-5xl mx-auto space-y-4">
        <div className="flex items-center gap-3 mb-2">
          ...
          <div>
            <h1 className="text-xl font-bold text-foreground" style={{ fontFamily: 'var(--font-display)', fontWeight: 400, letterSpacing: '-0.02em' }}>Clienti</h1>
            <p className="text-sm text-muted-foreground">Riepilogo nominativi con andamento ordini e pagamenti</p>
          </div>
        </div>
        <Card>
          <CardHeader>
            <CardTitle style={{ fontFamily: 'var(--font-display)', fontWeight: 400, letterSpacing: '-0.01em' }}>Filtri riepilogo</CardTitle>
